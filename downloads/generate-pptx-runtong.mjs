...
const HTML_FILE = path.join(__dirname, 'trading-erp-case.html');
const TEMP_DIR  = path.join(__dirname, 'pptx-temp-runtong');
const PPTX_FILE = path.join(__dirname, 'trading-erp-case.pptx');
